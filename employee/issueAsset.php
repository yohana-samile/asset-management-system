            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover dt-responsive display nowrap" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            $sn = 1;
                            $new_asset_record = $conn->query("SELECT * FROM assetissued, asset_managed, assetcategory, employee WHERE assetissued.assetBorrowed = asset_managed.asset_id and asset_managed.whichCategory = assetcategory.categoryId and employee.employee_id = {$_SESSION['userData']['employee_id']};");
                            ...
                            while($get_asset_result = mysqli_fetch_array($new_asset_record)):
                                if($get_asset_result > 0): ?>
                                    <tr>
                                        ...
                                        <td>                                            
                                            <?php
                                                if($get_asset_result['quantity'] == 0): ?>
                                                    <div class="container">
                                                ...
                                                <?php else:
                                                if($get_asset_result['requestStatusResult'] == "Returned" || $get_asset_result['requestStatusResult'] == "not taken" || $get_asset_result['requestStatusResult'] == "denied"){ 
